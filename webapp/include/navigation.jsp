  ...
  <div class="col-md-12">
    <div class="navbar-header">
      ...
      <ul class="nav dropdown-menu">
        <li><a href="${pageContext.request.contextPath}/users/profile?userId=${sessionScope.user.userId}"><i class="glyphicon glyphicon-user" style="color:#1111dd;"></i> Profile</a></li>
